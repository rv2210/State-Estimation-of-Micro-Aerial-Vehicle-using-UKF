...
for i= 1:n_prime
    ...
    positive_case= u_aug + ((sqrt(n_prime+lambda_prime)*cholesky_decomp(:,i)));
    negative_case= u_aug - ((sqrt(n_prime+lambda_prime)*cholesky_decomp(:,i)));
